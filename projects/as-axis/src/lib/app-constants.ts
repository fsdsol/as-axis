...
export class AppConstants {
  ...
  static remoteServiceAssetUrl: string = '';
  ...
  static isResjson: boolean = true;
  static isMultiRequest: boolean = false;
  static isTopMargin: boolean = true;
  ...
  static defaultHttpSuccessCodes: any = {
    ...
    '306': { code: 306, message: 'Switch Proxy' },
  ...
  static defaultHttpErrorCodes: any = {
    ...
    '416': { code: 416, message: 'Requested range not satisfiable' },
